...
def _with_agents_md() -> str:
    ...
    return (
        ...
        "This is an AUTHORING task: you are building a robot and a world from the declarative specs,\n"
        "not fixing a controller or satisfying a pre-defined scenario. You verify your work by\n"
        "bringing the sim up and checking the live ROS graph — that the robot spawns as model\n"
