...
This is the **camera-bot** template: a differential-drive robot with a forward-facing
**camera** (published on `/image`) in addition to the LiDAR — a starting point for
vision-based behaviours. View `/image` in Foxglove with an Image panel.
